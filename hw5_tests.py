...
class TestCard(unittest.TestCase):
    ...
    def test_q3(self):
        ...
        '''
        q3=Card(3,13)
        str_q3=q3.rank_name+' of '+q3.suit_name
        self.assertEqual(str_q3,"King of Spades")
        return str_q3,"King of Spades"
    ...
    def test_q8(self):
        card=Card(1,1)
        q8desk=Deck()
        q8desk.replace_card(card)
        self.assertEqual(len(q8desk.cards),52)
        return len(q8desk.cards),52
